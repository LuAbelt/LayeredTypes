...
\lstinputlisting[caption={Contracts in LiquidHaskell}, label={lst:liquidhaskell}]{BasicLT.hs}
...
\lstinputlisting[caption={Combining Refinement Types},label={lst:combined_refs}]{CombinedLT.hs}
